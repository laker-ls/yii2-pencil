...
```
$ php composer.phar require laker-ls/yii2-pencil "~1.0.1"
```

или добавьте в `composer.json` в раздел `require` следующую строку

```
"laker-ls/yii2-pencil": "~1.0.1"
```
...
В конфиге приложения подключите модуль и укажите роли (обязательно), для которых разрешен доступ:
```php
'modules' => [
    'pencil' => [
