...
- Исправлены незначительные ошибки валидации.

## Версия 2.2.4

**Дата:** 28-апреля-2020

- Исправлена ошибка возникающая при загрузке изображений с длинным наименованием.
- Исправлены пропорции изображений в модальном окне, изображения больше не растягиваются.

## Версия 2.2.3

**Дата:** 28-апреля-2020

- Добавлен индикатор загрузки изображений.
- Исправлено не корректное отображение изображение с длинными наименованиями, а так же отображение портретных изображений.
- Исправлена ошибка валидации, из-за которой нельзя было сохранить изменения в порядке изображений без загрузки дополнительных изображений.

## Версия 2.2.2

**Дата:** 03-марта-2020

- Исправлена ошибка, возникающая при использовании виджета в `layout`, который вызывается в контроллере без свойства `categoryId`.
