...
**Дата:** 07-октября-2019

- Исправлена ошибка, возникающая при удалении изображения.
...
- Изменен способ использования виджета `PencilImage`. Подробнее смотрите в 
[документации](https://github.com/laker-ls/yii2-pencil/blob/master/README.md) раздел "Использование".
